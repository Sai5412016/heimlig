...
const ITEM_EMOJIS: Record<string, string> = {
  'gurke': '🥒', 'salatgurke': '🥒',
  'brokkoli': '🥦', 'blumenkohl': '🥦',
  'tomaten': '🍅', 'tomate': '🍅', 'rispentomaten': '🍅',
  'cherrytomaten': '🍅🍅', 'cherry-tomaten': '🍅🍅', 'cherry tomaten': '🍅🍅',
  'äpfel': '🍎', 'apfel': '🍎',
  'bananen': '🍌', 'banane': '🍌',
  'karotten': '🥕', 'möhren': '🥕', 'karotte': '🥕', 'pastinaken': '🥕',
  'kartoffeln': '🥔', 'kartoffel': '🥔', 'süßkartoffeln': '🥔',
  'paprika': '🫑', 'spitzpaprika': '🫑',
  'rote paprika': '🌶️', 'rote spitzpaprika': '🌶️',
...
const ITEM_COLORS: Record<string, string> = {
  ...
  'tomaten': '#FF4444', 'tomate': '#FF4444', 'rispentomaten': '#FF4444',
  'cherrytomaten': '#FF4444', 'cherry-tomaten': '#FF4444', 'cherry tomaten': '#FF4444',
  'brokkoli': '#51CF66', 'blumenkohl': '#94A3B8',
  'gurke': '#74C69D', 'salatgurke': '#74C69D',
  'paprika': '#FF6B35', 'spitzpaprika': '#FF6B35',
  'rote paprika': '#E63946', 'rote spitzpaprika': '#E63946',
  ...
  'radieschen': '#FF4B6E', 'rote beete': '#9B2335', 'zucchini': '#4F9D5C', 'aubergine': '#6C3483',
  'erbsen': '#51CF66', 'bohnen': '#2D9E57', 'linsen': '#C49A6C', 'kichererbsen': '#D4A847', 'kidneybohnen': '#8B2E2E',
  // Obst (ergänzend)
  ...
  // Saucen & Gewürze
  'ketchup': '#FF4444', 'senf': '#FFD93D', 'mayonnaise': '#F5D293', 'mayo': '#F5D293', 'tomatenmark': '#C0392B',
  'soße': '#C49A6C', 'tomatensoße': '#FF4444', 'pestosoße': '#2D9E57', 'pesto': '#2D9E57',
  'essig': '#DDD5C8', 'balsamico': '#3D2B1F',
  // Tiefkühl
